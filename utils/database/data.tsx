type PricingPlan = { title: String; price: String; currency: String; description: String; mostPopular: Boolean }
...
export const pricingPlans: PricingPlan[] = [
	...
	},
	{
		...
		price: '₹1000',
		currency: 'INR',
		description: 'Experience maximum value with our most comprehensive package.',
		mostPopular: false,
	},
]
